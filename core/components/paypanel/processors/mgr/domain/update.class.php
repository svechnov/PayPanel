 ...
 * Update an Item
 */
class PayPanelZonesUpdateProcessor extends modObjectUpdateProcessor {
...
//		$name = trim($this->getProperty('name'));
        ...
        $this->setProperty('hide',  $this->getProperty('hide') == 'true' ? 1 : 0);
//		if (empty($name)) {
...
return 'PayPanelZonesUpdateProcessor';
